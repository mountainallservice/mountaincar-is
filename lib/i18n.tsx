...
const dict: Record<Lang, Record<string, string>> = {
  ...
  is: {
    ...
    "fleet.kicker": "Bílaflotinn okkar", "fleet.title": "Finndu fullkomna bílinn", "fleet.requestQuote": "Fá verðtilboð", "fleet.d1": "Klassíska valið. Áreiðanlegur 4x4 kraftur til að kanna hálendið og Ring Road.", "fleet.d2": "Tilbúinn í ævintýri. Krafturinn frá 4x4 Duster ásamt þægilegu þaktjaldi.", "fleet.d3": "Rúmgóður húsbíll með beinskiptingu og öllu því nauðsynlega fyrir ferðalagið þitt.", "fleet.d4": "Nettur húsbíll fyrir 4–5 manns. Þaktjald, tjaldbúnaður, frítt WiFi — fullkominn fyrir pör eða litla hópa.", "spec.Seats": "Sæti", "spec.Doors": "Hurðir", "spec.Fuel": "Eldsneyti", "spec.Gearbox": "Gírkassi", "spec.Cargo": "Farangursrými", "spec.AC": "Loftkæling", "spec.Engine": "Vél", "spec.Drive": "Drif", "spec.Tent": "Tjald", "spec.WiFi": "WiFi", "val.Manual": "Beinskiptur", "val.Rooftop": "Þaktjald", "val.Free": "Frítt",
    "addons.kicker": "Bættu ferðina þína", "addons.title": "Nauðsynlegir aukahlutir", "addon.gps": "GPS leiðsögn", "addon.wifi": "Wi-Fi heitir reitir", "addon.tent": "Tjald og tjaldbúnaður", "addon.cooler": "Færanlegir kælir", "addon.blanket": "Hitateppi", "addon.childseat": "Barnabílstólar", "addon.roofrack": "Þakgrindur", "addon.gas": "Gaskútar",
